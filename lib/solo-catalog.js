...
// specific one instead" picker offers the same set, in a stable (not shuffled) order. Flags and
// Borders quizzes are folded into Geography now, so they're already part of this pool.
