...
// challenge.html, and server.js all render off this file, so nothing needs to be
...
module.exports = {
  ...
  // challenge.html — share-link stub; server.js overrides og/title per ?id= with the
  ...
  // Served instead of the app when the cost guard trips (server.js BUDGET_PAGE).
  paused: {
