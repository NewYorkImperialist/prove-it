...
export const metadata = {
  ...
  // black). Both come from the same mark — see lib/favicon.js and scripts/make-icons.js.
  //
  // There's no prefers-color-scheme variant here on purpose: the mark is now dark-plated in every
  // context, so a "dark version" would be the same image twice.
