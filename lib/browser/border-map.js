// Country-outline rendering for the Borders quiz: one country's shape at a time, auto-fit
...
// atlas at this resolution (see lib/borders.js for which ones those are and why).
export async function borderPaths(entries, w, h) {
