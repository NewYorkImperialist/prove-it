...
// quizzes, just answered by recognizing the country's shape instead of its flag. Played on the
// same real geography map "Countries in ..." itself uses (lib/browser/geomap.js), one shape
// highlighted as the current target instead of lit up in any order (see lib/geo-cats.js, which
// is what actually routes these names to "map" mode); this file only decides which entries
// qualify.
//
