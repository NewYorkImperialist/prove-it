...
// Used by lib/browser/geomap.js (the map/fill boards) and lib/browser/border-map.js (the
// Borders quiz) — kept in one place so a name-patch fix benefits both instead of drifting.
