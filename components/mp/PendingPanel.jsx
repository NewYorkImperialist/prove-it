...
const BTN = "cursor-pointer rounded-lg border-none px-3 py-[7px] text-[13px] font-bold";
...
function RejectAll({ label, onClick }) {
  return (
    <button type="button" onClick={onClick} className="cursor-pointer self-end border-none bg-transparent px-1 py-0.5 text-xs text-muted underline">
      {label}
    </button>
  );
}
