...
// (rendered client-side, see lib/browser/border-map.js) instead of its flag or its name. A
// couple of countries have no drawable polygon at the atlas's resolution (lib/borders.js) and
// are dropped rather than shown as a blank tile.
...
const geoBoardCats = () => [...CATS.filter((c) => hasGeoBoard(c.name)), ...FLAG_CATS, ...BORDER_CATS].map((c) => c.name);
