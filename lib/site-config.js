...
module.exports = {
  ...
  themeColor: "#0c0a07",
  // Bump `v` whenever og-card.png's contents change, so crawlers/clients don't serve a stale
  // cached image. One hand-made card for every share link — there was briefly a second, generated
  // per link by app/og.png/route.js, but it was switched off and has now been removed along with
  // the `ogCard` key that configured it.
